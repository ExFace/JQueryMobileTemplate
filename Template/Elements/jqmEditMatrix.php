...
class jqmEditMatrix extends jqmDataMatrix {
	protected $element_type = 'datagrid';
	private $label_values = array();
	
	function generate_headers(){
		return array (
				'<script src="exface/vendor/exface/JQueryMobileTemplate/Template/js/handsontable/dist/jquery.handsontable.full.js"></script>',
				'<link rel="stylesheet" media="screen" href="exface/vendor/exface/JQueryMobileTemplate/Template/js/handsontable/dist/jquery.handsontable.full.css">'
				);
	}
	 ...
	 * @see \exface\JQueryMobileTemplate\Template\Elements\grid::render_column_headers()
	 */
	 ...
	 * @see \exface\JQueryMobileTemplate\Template\Elements\grid::render_data_source()
	 */
