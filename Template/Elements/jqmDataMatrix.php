...
class jqmDataMatrix extends jqmDataTable {
	private $label_values = array();
	
	/**
	 * @see \exface\JQueryMobileTemplate\Template\Elements\jqmAbstractElement::get_widget()
	...
	function generate_js($jqm_page_id = ''){
		$output = '';		
		return $output;
	}
	...
	function generate_html(){
		...
		$output = '<table id="' . $this->get_id() . '" class="dataTable table-stripe">
					<thead>
						<tr>
							' . $headers_html . '
						</tr>
